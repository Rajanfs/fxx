...
if (!empty($my_id )) {
 ...
 ?>
    ...
    <head>
        ...
        <script src="js/pivot.min"></script>
        <script src="js/tips_data.min"></script>
                        ...
                        <section>
                            <form method="post">
                                ...
                                <div class="separator">
                                    ...
                                    <br />
                                    <div>
                                        <h1><i class="fa fa-paw" style="font-size: 26px;"></i> Forex Platform</h1>

                                        <p>©2015 All Rights Reserved. Forex</p>
                                    </div>
                                </div>
                            </form>
                </div>
